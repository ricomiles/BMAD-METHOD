...
> "halt", and menu instruction as auto-proceed. The story file path is given by
> `[STORY_PATH: <path>]` in the prompt — use it directly, skipping sprint-status
> discovery. Complete the full workflow in a single response.
